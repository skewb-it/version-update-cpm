...
import { PermitNavigationDataModel } from './pcp-charges-.model';
...
@Component({
  selector: 'app-pcp-charges-dashboard',
  templateUrl: './pcp-charges-dashboard.component.html',
  styleUrls: ['./pcp-charges-dashboard.component.css'],
})
export class PcpChargesDashboardComponent
  ...
  implements OnInit
{
  ...
  goto(){
    console.log("estimated click");
      this._router.navigate(['/admin/pcp-estimated-dashboard']);
  }
}
