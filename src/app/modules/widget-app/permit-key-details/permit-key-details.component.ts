import { ASSESSMENT_STATUS, PERMIT_ACTIONS_CONFIG, PRODUCT_SERVICES } from 'src/app/constants/app-repo.constants';
import { AssessmentDecision, PermitKeyDetailsConfigModel, PermitKeyDetailsModel } from './permit-key-details.model';
import { Component, Input, OnInit } from '@angular/core';
import { ElginMapConfigModel, ElginMapDataModel } from '../elginmap/elginmap-model';
import { StepperCostConfigModel, StepperCostDataModel } from '../../widget/stepper/stepper-cost/stepper-cost.model';
...
@Component({
  selector: 'app-permit-key-details',
  templateUrl: './permit-key-details.component.html',
  styleUrls: ['./permit-key-details.component.css'],
  providers: [TransformCurrencyPipe]
})
export class PermitKeyDetailsComponent extends WidgetComponentBase implements OnInit {

  hideWidget:boolean=false;

  @Input() dataModel: PermitKeyDetailsModel;
  @Input() configModel: PermitKeyDetailsConfigModel;
  ...
  ngAfterViewInit(): void {
    ...
    if(this._appRepoService.appRepo.appProductCode ==
