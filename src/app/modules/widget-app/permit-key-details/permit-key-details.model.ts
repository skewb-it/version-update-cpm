...
export class PermitKeyDetailsConfigModel {

  stepperCostConfigModel : StepperCostConfigModel;


  static getInstance<T>(): PermitKeyDetailsConfigModel {
    let model = new PermitKeyDetailsConfigModel();
    model.stepperCostConfigModel = StepperCostConfigModel.getInstance();
...
export class PermitKeyDetailsModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  ...
  static getInstance<T>(): PermitKeyDetailsModel {
    let model = new PermitKeyDetailsModel();
    model.isSelfDataLoad = true;
    model.globalParamterKeys = [];
    model.globalParameters = new Map<any, any>();
    model.data = new PermitOvervieDetailsModel();

    model.stepperCostDataModel = StepperCostDataModel.getInstance();
