...
export class InvoiceDetailsBarConfigModel {
  static getInstance<T>(): InvoiceDetailsBarConfigModel {
    let model = new InvoiceDetailsBarConfigModel();
    return model;
  }
...
export class InvoiceDetailsBarModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): InvoiceDetailsBarModel {
    let model = new InvoiceDetailsBarModel();
