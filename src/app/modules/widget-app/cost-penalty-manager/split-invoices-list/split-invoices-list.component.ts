...
import {
  ...
  SplitInvoicesRow,
} from './split-invoices-list.model';
...
@Component({
  selector: 'app-split-invoices-list',
  templateUrl: './split-invoices-list.component.html',
  styleUrls: ['./split-invoices-list.component.css'],
  animations: [
...
export class SplitInvoicesListComponent extends WidgetComponentBase {
  @Input() dataModel: SplitInvoicesListDataModel;
  @Input() configModel: SplitInvoicesListConfigModel;
  PERMIT_ACTIONS_CONFIG = PERMIT_ACTIONS_CONFIG;
  dataSource = new MatTableDataSource<SplitInvoicesRow>();
  expandedElement: SplitInvoicesRow;
