...
export class EmailInvoiceFormConfigModel {
  static getInstance<T>(): EmailInvoiceFormConfigModel {
    let model = new EmailInvoiceFormConfigModel();
    return model;
  }
...
export class EmailInvoiceFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): EmailInvoiceFormModel {
    let model = new EmailInvoiceFormModel();
