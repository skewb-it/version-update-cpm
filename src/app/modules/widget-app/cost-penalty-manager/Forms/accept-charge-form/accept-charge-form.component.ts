...
@Component({
  selector: 'app-accept-charge-form',
  templateUrl: './accept-charge-form.component.html',
  styleUrls: ['./accept-charge-form.component.css'],
})
export class AcceptChargeFormComponent
  extends WidgetComponentBase
  implements OnInit
{
  @Input() dataModel: AcceptChargeFormModel;
  @Input() configModel: AcceptChargeFormConfigModel;

  AcceptChargeForm: FormGroup;
  ...
  OnDestroy() {
    this.AcceptChargeForm.reset();
  }
  createFormGroup(): void {
    this.AcceptChargeForm = this.fb.group({
      fileUp: [''],
  ...
  getValue() {
    ...
    if (this.AcceptChargeForm.valid) {
      return this.AcceptChargeForm.value;
    }
  }
