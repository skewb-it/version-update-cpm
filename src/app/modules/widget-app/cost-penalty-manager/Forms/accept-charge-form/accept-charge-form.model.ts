...
export class AcceptChargeFormConfigModel {
  static getInstance<T>(): AcceptChargeFormConfigModel {
    let model = new AcceptChargeFormConfigModel();
    return model;
  }
...
export class AcceptChargeFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): AcceptChargeFormModel {
    let model = new AcceptChargeFormModel();
