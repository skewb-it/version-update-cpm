...
export class AssignJobOwnerConfigModel {
  static getInstance<T>(): AssignJobOwnerConfigModel {
    let model = new AssignJobOwnerConfigModel();
    return model;
  }
...
export class AssignJobOwnerModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): AssignJobOwnerModel {
    let model = new AssignJobOwnerModel();
