...
import { RaisePOConfigModel, RaisePOModel } from './raise-po-form.model';
...
@Component({
  selector: 'app-raise-po-form',
  templateUrl: './raise-po-form.component.html',
  styleUrls: ['./raise-po-form.component.css'],
})
export class RaisePoFormComponent
  extends WidgetComponentBase
  implements OnInit
{
  @Input() dataModel: RaisePOModel;
  @Input() configModel: RaisePOConfigModel;
  ...
  createFormGroup() {
    this.createForm = this.fb.group({
      ...
      recipentEmail: ['', [Validators.email]],
      website: [''],
      phone: [''],
      otherCharges: [''],
      status: [''],
