...
export class RaisePOConfigModel {
  static getInstance<T>(): RaisePOConfigModel {
    let model = new RaisePOConfigModel();
    return model;
  }
...
export class RaisePOModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): RaisePOModel {
    let model = new RaisePOModel();
