...
export class EmailInvoiceForm2ConfigModel {
  static getInstance<T>(): EmailInvoiceForm2ConfigModel {
    let model = new EmailInvoiceForm2ConfigModel();
    return model;
  }
...
export class EmailInvoiceForm2Model {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): EmailInvoiceForm2Model {
    let model = new EmailInvoiceForm2Model();
