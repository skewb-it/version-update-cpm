...
} from './dispute-charge-form.model';
...
@Component({
  selector: 'app-dispute-charge-form',
  templateUrl: './dispute-charge-form.component.html',
  styleUrls: ['./dispute-charge-form.component.css'],
})
export class DisputeChargeFormComponent
  extends WidgetComponentBase
  implements OnInit
{
  @Input() dataModel: DisputeChargeFormModel;
  @Input() configModel: DisputeChargeFormConfigModel;

  DisputeChargeForm: FormGroup;
  ...
  OnDestroy() {
    this.DisputeChargeForm.reset();
  }
  createFormGroup(): void {
    this.DisputeChargeForm = this.fb.group({
      fileUp: [''],
  ...
  getValue() {
    ...
    if (this.DisputeChargeForm.valid) {
      return this.DisputeChargeForm.value;
    }
  }
  ...
  openFileUpload() {
    ...
    this.emitEvent('openFileUploadDisputeDialog', data);
  }
}
