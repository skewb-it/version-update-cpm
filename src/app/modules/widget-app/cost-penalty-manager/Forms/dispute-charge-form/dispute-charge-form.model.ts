...
export class DisputeChargeFormConfigModel {
  static getInstance<T>(): DisputeChargeFormConfigModel {
    let model = new DisputeChargeFormConfigModel();
    return model;
  }
...
export class DisputeChargeFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): DisputeChargeFormModel {
    let model = new DisputeChargeFormModel();
