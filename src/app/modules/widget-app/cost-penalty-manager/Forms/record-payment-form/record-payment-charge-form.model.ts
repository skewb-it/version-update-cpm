...
export class RecordPaymentChargeFormConfigModel {
  static getInstance<T>(): RecordPaymentChargeFormConfigModel {
    let model = new RecordPaymentChargeFormConfigModel();
    return model;
  }
...
export class RecordPaymentChargeFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): RecordPaymentChargeFormModel {
    let model = new RecordPaymentChargeFormModel();
