...
export class RecordNegotiatedChargeFormConfigModel {
  static getInstance<T>(): RecordNegotiatedChargeFormConfigModel {
    let model = new RecordNegotiatedChargeFormConfigModel();
    return model;
  }
...
export class RecordNegotiatedChargeFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): RecordNegotiatedChargeFormModel {
    let model = new RecordNegotiatedChargeFormModel();
