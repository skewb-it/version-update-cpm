...
export class AssignLiabilityConfigModel {
  static getInstance<T>(): AssignLiabilityConfigModel {
    let model = new AssignLiabilityConfigModel();
    return model;
  }
...
export class AssignLiabilityModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): AssignLiabilityModel {
    let model = new AssignLiabilityModel();
