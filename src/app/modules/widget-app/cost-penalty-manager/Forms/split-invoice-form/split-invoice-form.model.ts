...
export class SplitInvoiceFormConfigModel {
  static getInstance<T>(): SplitInvoiceFormConfigModel {
    let model = new SplitInvoiceFormConfigModel();
    return model;
  }
...
export class SplitInvoiceFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): SplitInvoiceFormModel {
    let model = new SplitInvoiceFormModel();
