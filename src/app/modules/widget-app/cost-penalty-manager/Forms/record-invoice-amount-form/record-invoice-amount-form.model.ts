...
export class RecordInvoiceAmountFormConfigModel {
  static getInstance<T>(): RecordInvoiceAmountFormConfigModel {
    let model = new RecordInvoiceAmountFormConfigModel();
    return model;
  }
...
export class RecordInvoiceAmountFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): RecordInvoiceAmountFormModel {
    let model = new RecordInvoiceAmountFormModel();
