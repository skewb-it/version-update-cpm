...
} from './record-invoice-amount-form.model';
...
@Component({
  selector: 'app-record-invoice-amount-form',
  templateUrl: './record-invoice-amount-form.component.html',
  styleUrls: ['./record-invoice-amount-form.component.css'],
})
export class RecordInvoiceAmountFormComponent
  extends WidgetComponentBase
  implements OnInit
{
  @Input() dataModel: RecordInvoiceAmountFormModel;
  @Input() configModel: RecordInvoiceAmountFormConfigModel;

  RecordInvoiceAmountForm: FormGroup;
  ...
  convertData(response: any) {
    ...
    this.dataModel.data.invoiceReferenceNumber =
      response.invoiceReferenceNumber;
