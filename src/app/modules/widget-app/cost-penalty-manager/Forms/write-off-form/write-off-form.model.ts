...
export class WriteOffChargeFormConfigModel {
  static getInstance<T>(): WriteOffChargeFormConfigModel {
    let model = new WriteOffChargeFormConfigModel();
    return model;
  }
...
export class WriteOffChargeFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): WriteOffChargeFormModel {
    let model = new WriteOffChargeFormModel();
