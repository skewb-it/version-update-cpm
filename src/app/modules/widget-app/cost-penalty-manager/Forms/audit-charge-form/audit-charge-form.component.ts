...
@Component({
  selector: 'app-audit-charge-form',
  templateUrl: './audit-charge-form.component.html',
  styleUrls: ['./audit-charge-form.component.css'],
})
export class AuditChargeFormComponent
  extends WidgetComponentBase
  implements OnInit
{
  @Input() dataModel: AuditChargeFormModel;
  @Input() configModel: AuditChargeFormConfigModel;

  AuditChargeForm: FormGroup;
  ...
  createFormGroup(): void {
    this.AuditChargeForm = this.fb.group({
  ...
  getValue() {
    if (this.AuditChargeForm.valid) {
      return this.AuditChargeForm.value;
    }
  }

  resetForm() {
    this.AuditChargeForm.reset();
  }
  openFileUpload() {
    let data: any = new Object();
    this.emitEvent('openFileUploadAuditDialog', data);
  }
}
