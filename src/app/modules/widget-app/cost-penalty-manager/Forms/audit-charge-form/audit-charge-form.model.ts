...
export class AuditChargeFormConfigModel {
  static getInstance<T>(): AuditChargeFormConfigModel {
    let model = new AuditChargeFormConfigModel();
    return model;
  }
...
export class AuditChargeFormModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): AuditChargeFormModel {
    let model = new AuditChargeFormModel();
