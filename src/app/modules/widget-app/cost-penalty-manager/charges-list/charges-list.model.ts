...
export class ChargesListConfigModel {
  static getInstance<T>(): ChargesListConfigModel {
    let model = new ChargesListConfigModel();
    return model;
  }
...
export class ChargesListDataModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  ...
  filterType: any;
  journeyType: any;
  apiUrls: ChargesListingAPIURL = new ChargesListingAPIURL();
  static getInstance<T>(): ChargesListDataModel {
    let model = new ChargesListDataModel();
    model.isSelfDataLoad = false;
    model.columnsToDisplay = undefined;
    model.globalParameters = new Map<any, any>();
    model.apireqdata = new ChargesListRequestModel();
...
export class ChargesListRequestModel {
  skip: number = 0;
...
export class ChargesListingAPIURL {
