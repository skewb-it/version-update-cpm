...
import { ChargeOverviewModel, ChargeOverviewConfigModel } from '../charge-overview-tab/charge-overview-tab.model';
import { FpnChargeOverviewConfigModel, FpnChargeOverviewModel } from './fpn-charges-overview-model';

@Component({
  selector: 'app-fpn-charges-overview-tab',
  templateUrl: './fpn-charges-overview-tab.component.html',
  styleUrls: ['./fpn-charges-overview-tab.component.css']
})

export class FpnChargesOverviewTabComponent extends WidgetComponentBase
  implements OnInit
{
  @Input() dataModel: FpnChargeOverviewModel;
  @Input() configModel: FpnChargeOverviewConfigModel;
  ...
  convertData(response: any) {
    ...
    this.dataModel.data.preApprovalAuthoriser =
      ...
      this.dataModel.data.grantedDate = response.grantedDate ;
      this.dataModel.data.issuedDate = response.issuedDate ;
      this.dataModel.data.dateAccepted = response.dateAccepted ;
      this.dataModel.data.dateFPNpaid = response.dateFPNpaid ;
      this.dataModel.data.workType = response.workType ;
      this.dataModel.data.spendType = response.spendType ;
      this.dataModel.data.costcode = response.costcode ;
