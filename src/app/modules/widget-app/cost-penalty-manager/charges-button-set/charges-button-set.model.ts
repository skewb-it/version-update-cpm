...
export class ChargesButtonConfigModel {
  static getInstance<T>(): ChargesButtonConfigModel {
    let model = new ChargesButtonConfigModel();
    return model;
  }
...
export class ChargesButtonModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  ...
  static getInstance<T>(): ChargesButtonModel {
    let model = new ChargesButtonModel();
    model.isSelfDataLoad = true;
    model.globalParamterKeys = [];
    model.globalParameters = new Map<any, any>();
    model.data = new ChargesButtonDetailsModel();
    return model;
  }
  data: ChargesButtonDetailsModel;
  defaultSortDirection: string;
}

export class ChargesButtonDetailsModel {
  permitRefNumber: any;
