...
export class ChargeKeyDetailsConfigModel {
  static getInstance<T>(): ChargeKeyDetailsConfigModel {
    let model = new ChargeKeyDetailsConfigModel();
    return model;
  }
...
export class ChargeKeyDetailsModel {
  isGlobalParams: any;
  isSelfDataLoad: any;
  globalParamterKeys: any;
  globalParameters: Map<any, any>;

  static getInstance<T>(): ChargeKeyDetailsModel {
    let model = new ChargeKeyDetailsModel();
