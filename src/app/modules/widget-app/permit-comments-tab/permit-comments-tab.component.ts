...
import { PermitCommentsRow, PermitCommentsConfigModel, PermitCommentsRequestModel, PermitCommentsDataModel } from './permit-comments-tab.module';

@Component({
  selector: 'app-permit-comments-tab',
  templateUrl: './permit-comments-tab.component.html',
  styleUrls: ['./permit-comments-tab.component.css']
})
export class PermitCommentsTabComponent extends WidgetComponentBase {
  ...
  getControlData() {
    ...
    return this.wgAPIMethodGet(`/api/v1/applications/${id}/comments`, this._permitCommentsRequestModel);
  }
  ...
  ngOnInit()//
  {
    ...
    this.pageChangeSubscription = this.paginator.page.subscribe(() => {
      ...
      this._permitCommentsRequestModel.skip = this._permitCommentsRequestModel.pageno * this._permitCommentsRequestModel.top;
