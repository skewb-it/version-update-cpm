...
import { StepperCostConfigModel, StepperCostDataModel } from './stepper-cost.model';

import { ServerApiInterfaceServiceService } from 'src/app/services/server-api-interface-service.service';
import { StepperConfigModel } from '../stepper/stepper.model';
...
@Component({
  selector: 'app-stepper-cost',
  templateUrl: './stepper-cost.component.html',
  styleUrls: ['./stepper-cost.component.css'],
  providers: [TransformDatePipe, TransformCurrencyPipe]
})
export class StepperCostComponent extends WidgetComponentBase implements OnInit {
