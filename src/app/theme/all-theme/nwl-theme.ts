...
export const theme: ThemeModel = {
  ...
  properties: {
    ...
    "--theme-color-border-light": "#224595",
    "--login-page-title-color": "#2B5C41",
    "--login-page-subtitle-color": "#66B32F",
    "--stroked-button-bg-color": "#004595",
    "--isSVGimagerender":"true",
    "--isopuslogorender":"true",
    "--ispoweredbyimageshow":"true"
